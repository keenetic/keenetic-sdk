...
Write down the version of KeeneticOS (e.g. `3.07.A.10.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20210524_2020_KN-1010-3.07.A.10.0-0.bin`)
