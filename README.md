...
Write down the version of KeeneticOS (e.g. `4.00.C.0.0-2`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20230921_1800_KN-1010-4.00.C.0.0-2.bin`)
