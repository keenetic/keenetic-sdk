...
Write down the version of KeeneticOS (e.g. `3.07.C.2.0-1`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20220216_1533_KN-1010-3.07.C.2.0-1.bin`)
