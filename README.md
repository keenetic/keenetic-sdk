...
Write down the version of KeeneticOS (e.g. `3.08.C.0.0-3`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20220614_1448_KN-1010-3.08.C.0.0-3.bin`)
