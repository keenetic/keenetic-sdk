...
Write down the version of KeeneticOS (e.g. `4.00.B.3.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20230921_1748_KN-1010-4.00.B.3.0-0.bin`)
