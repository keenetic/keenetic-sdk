...
Write down the version of KeeneticOS (e.g. `3.07.B.0.0-2`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20210813_1751_KN-1010-3.07.B.0.0-2.bin`)
