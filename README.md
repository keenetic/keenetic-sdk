...
Write down the version of KeeneticOS (e.g. `3.07.A.3.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20210326_1127_KN-1010-3.07.A.3.0-0.bin`)
