...
Write down the version of KeeneticOS (e.g. `3.09.C.7.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20230615_1832_KN-1010-3.09.C.7.0-0.bin`)
