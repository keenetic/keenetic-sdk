...
Write down the version of KeeneticOS (e.g. `5.00.C.12.1-1`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20260703_1740_KN-1010-5.00.C.12.1-1.bin`)
