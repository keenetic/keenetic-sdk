...
Write down the version of KeeneticOS (e.g. `3.07.B.7.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20211125_1807_KN-1010-3.07.B.7.0-0.bin`)
