...
Write down the version of KeeneticOS (e.g. `4.00.B.1.0-0`).
...
We recommend to use the latest long-term support (LTS) version of Ubuntu (https://ubuntu.com/download).
	...
	# apt install attr bc build-essential curl gawk git gperf jq libhtml-parser-perl libjson-perl libncurses-dev libssl-dev libxml-libxml-perl python python3 subversion unzip zlib1g-dev
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20230921_1557_KN-1010-4.00.B.1.0-0.bin`)
