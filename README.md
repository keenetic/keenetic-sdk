...
Write down the version of KeeneticOS (e.g. `3.09.B.1.0-3`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20230615_1651_KN-1010-3.09.B.1.0-3.bin`)
