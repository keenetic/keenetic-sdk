...
Write down the version of KeeneticOS (e.g. `3.07.C.1.0-3`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20211228_1942_KN-1010-3.07.C.1.0-3.bin`)
