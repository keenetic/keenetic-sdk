...
Write down the version of KeeneticOS (e.g. `3.07.A.17.0-0`).
...
You can find the firmware file in the 'bin' directory (e.g. `bin/mt7621/20210813_1742_KN-1010-3.07.A.17.0-0.bin`)
