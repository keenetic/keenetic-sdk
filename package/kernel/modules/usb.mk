...
define KernelPackage/usb3
  ...
  DEPENDS:=\
	+kmod-usb-xhci-hcd \
	+!HAS_EXTERNAL_USB:kmod-usb-xhci-mtk
  KCONFIG:=\
	CONFIG_USB_XHCI_PCI \
...
define KernelPackage/usb-xhci-mtk/config
  if PACKAGE_kmod-usb-xhci-mtk
	config KERNEL_USB_XHCI_MTK_DEBUGFS
		bool
		depends on (TARGET_mt7981 || TARGET_mt7986 || TARGET_mt7987 || TARGET_mt7988)
		default y if PACKAGE_ndm-mod-factory=y
		default n
